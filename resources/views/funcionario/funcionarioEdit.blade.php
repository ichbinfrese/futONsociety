...
@section('title', 'FutON - Edição de funcionários da arena')
...
<form action="{{ action('App\Http\Controllers\FuncionarioController@save', $funcionario->id) }}" method="post" style="color: #000000;">
