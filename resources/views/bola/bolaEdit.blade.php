...
@section('title', 'FutON - Edição de bolas da arena')
...
<form action="{{ action('App\Http\Controllers\BolaController@save', $bola->id) }}" method="post" style="color: #000000;">
<input type="hidden" name="_token" value="{{{ csrf_token() }}}">
<div class="form-row">
    <div class="form-group col-md-6">
        <label>Nome </label>
            <input type="text" name="nome" class="form-control" value="{{$bola->nome}}">
</div>
</div>
...
<div class="form-row">
    <div class="form-group col-md-6">
        <label>Marca </label>
            <input type="text" name="marca" class="form-control" value="{{$bola->marca}}">
</div>
</div>
...
<div class="form-row">
    <div class="form-group col-md-6">
        <label>Composição </label>
            <input type="text" name="composicao" class="form-control"value="{{$bola->composicao}}">
</div>
</div>
...
<div class="form-row">
    <div class="form-group col-md-6">
        <label>Circunferência </label>
            <input type="text" name="circunferencia" class="form-control"value="{{$bola->circunferencia}}">
</div>
</div>
