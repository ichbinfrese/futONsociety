...
<body>
    ...
    <h3 style="color: #c5c5c5;"><b>FutON</b><i class="fas fa-futbol" style="color: #FF44EE;"></i><i class="fas fa-futbol" style="color: #F4E285;"></i><i class="fas fa-futbol" style="color: #78A25E;"></i> - Sistema de gerenciamento de arena municipal de futebol society</h3>
    ...
    <form action="<?php echo e(action('App\Http\Controllers\AgendaHorarioController@salvar', $agendahorario->id)); ?>" method="post" style="color: #ffffff;">
        ...
        <label>Título <i class="fas fa-keyboard" style="color: #FF44EE;"></i></label>
    ...
    <div class="form-row">
        <div class="form-group col-md-8">
        <label>Jogador responsável <i class="fas fa-running" style="color: #FF44EE;"></i></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\projetoLavaCao\resources\views/horario/horarioEditar.blade.php ENDPATH**/ ?>