...
<div class="col-6">
    ...
    <a href="<?php echo e(url('/jogador/create')); ?>" class="btn btn-outline-success"> <i class="fas fa-plus"></i> Cadastrar</a>
</div>
</div>
...
<tr>
    ...
    <th scope="col">Preferência de bola </th>
...
<tbody>
    <?php $__currentLoopData = $jogadores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <td><a href="<?php echo e(action('App\Http\Controllers\JogadorController@edit',$item->id )); ?>" style='color:orange;' ><i class='fas fa-user-edit'></i></a> </td>
        <td><a href="<?php echo e(action('App\Http\Controllers\JogadorController@delete',$item->id )); ?>"style='color:red;'><i class='fas fa-trash-alt'></i></a> </td>
    </tr>
