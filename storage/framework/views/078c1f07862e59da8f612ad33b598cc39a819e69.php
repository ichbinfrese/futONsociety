...
<div class="col-6">
    <button type="submit" class="btn btn-outline-primary"> <i class="fas fa-search"></i> Buscar</button>
        <a href="<?php echo e(url('/bola/create')); ?>" class="btn btn-outline-success"> <i class="fas fa-plus"></i> Cadastrar</a>
</div>
</div>
</form>
<br>
...
<tbody>
    <?php $__currentLoopData = $bolas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <td><a href="<?php echo e(action('App\Http\Controllers\BolaController@edit',$item->id )); ?>" style='color:orange;' ><i class='fas fa-user-edit'></i></a> </td>
        <td><a href="<?php echo e(action('App\Http\Controllers\BolaController@delete',$item->id )); ?>"style='color:red;'><i class='fas fa-trash-alt'></i></a> </td>
 </tr>
