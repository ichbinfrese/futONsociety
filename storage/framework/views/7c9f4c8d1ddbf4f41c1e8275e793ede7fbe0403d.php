...
<form action="<?php echo e(action('App\Http\Controllers\QuadraController@save', $quadra->id)); ?>" method="post" style="color: #000000;">
...
<div class="form-row">
    <div class="form-group col-md-6">
        <label>Cor do gramado </label>
            <input type="text" name="cor_gramado" class="form-control" value="<?php echo e($quadra->cor_gramado); ?>">
</div>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\futONsociety\resources\views/quadra/quadraEdit.blade.php ENDPATH**/ ?>