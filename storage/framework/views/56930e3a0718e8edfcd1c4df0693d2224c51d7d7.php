...
<body>
    ...
    <form action="<?php echo e(action('App\Http\Controllers\JogadorController@salvar', 0)); ?>" method="post" style="color: #ffffff;">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\futONsociety\resources\views/jogador/jogadorCadastrar.blade.php ENDPATH**/ ?>